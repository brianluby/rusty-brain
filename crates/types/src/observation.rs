...
pub struct Observation {
    /// Unique identifier (UUID v4), auto-generated on construction.
    pub id: Uuid,
    ...
    pub summary: String,
    /// Detailed content body (must not be empty).
    pub content: String,
...
impl Observation {
    ...
    /// # Errors
    ///
    /// Returns [`AgentBrainError::InvalidInput`] with code
    /// [`error_codes::E_INPUT_EMPTY_FIELD`] if `summary` or `content` is empty
...
mod tests {
    ...
    fn observation_struct_fields_are_publicly_readable() {
        ...
        let obs = Observation {
            ...
            content: "Detailed description of the discovery".to_string(),
            metadata: None,
        };
        assert_eq!(obs.id, id);
        ...
        assert_eq!(obs.content, "Detailed description of the discovery");
    ...
    fn observation_struct_fields_with_metadata() {
        ...
        let obs = Observation {
            ...
            content: "Replaced unsafe deref with Option handling".to_string(),
    ...
    fn observation_new_valid_without_metadata_succeeds() {
        let result = Observation::new(
            ...
            "A valid content body".to_string(),
            None,
        );
        assert!(result.is_ok());
        ...
        assert_eq!(obs.content, "A valid content body");
        assert!(obs.metadata.is_none());
    }
    ...
    fn observation_new_valid_with_metadata_succeeds() {
        ...
        let result = Observation::new(
            ...
            "Implemented the /store endpoint with validation".to_string(),
            Some(metadata),
        );
        assert!(result.is_ok());
        let obs = result.unwrap();
    ...
    fn observation_new_auto_generates_timestamp() {
        ...
        let obs = Observation::new(
            ...
            "The pattern repeats across three files".to_string(),
            None,
        )
        .unwrap();
        let after = Utc::now();
    ...
    // -------------------------------------------------------------------------
    // T005: Observation::new() — rejects empty content
    // -------------------------------------------------------------------------

    #[test]
    fn observation_new_empty_content_returns_invalid_input_error() {
        let result = Observation::new(
    ...
    #[test]
    fn observation_new_empty_content_has_empty_field_error_code() {
        let result = Observation::new(
            ObservationType::Solution,
            "bash".to_string(),
            "Valid summary".to_string(),
    ...
    // -------------------------------------------------------------------------
    // T005: Observation::new() — rejects whitespace-only content
    // -------------------------------------------------------------------------

    #[test]
    fn observation_new_whitespace_only_content_returns_invalid_input_error() {
        let result = Observation::new(
    ...
    #[test]
    fn observation_new_whitespace_only_content_has_empty_field_error_code() {
        let result = Observation::new(
            ObservationType::Refactor,
            "edit".to_string(),
            "Valid summary".to_string(),
    ...
    #[test]
    fn observation_new_single_newline_content_returns_invalid_input_error() {
        let result = Observation::new(
            ObservationType::Feature,
            "bash".to_string(),
            "Valid summary".to_string(),
    ...
    fn observation_json_round_trip_all_fields() {
        ...
        let original = Observation {
            ...
            content: "The pattern repeats across multiple files".to_string(),
            metadata: Some(metadata),
        };
    ...
    fn observation_json_round_trip_unicode() {
        ...
        let original = Observation {
            ...
            content: "RTL text مرحبا and more CJK 日本語テスト".to_string(),
            metadata: None,
        };
        ...
        assert!(
            deserialized.content.contains("مرحبا"),
